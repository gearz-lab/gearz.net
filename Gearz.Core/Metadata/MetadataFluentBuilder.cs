...
{
    public abstract class MetadataFluentBuilder<T, TParentUIContext, TSelf> : IMetadataFluentBuilder<T, TParentUIContext, TSelf>
        where TParentUIContext : UIContext
        where TSelf : class
    {
        [NotNull]
        private readonly IMetadataBuilder<T, TParentUIContext> inner;
        ...
        /// The inner.
        /// </param>
        public MetadataFluentBuilder([NotNull] IMetadataBuilder<T, TParentUIContext> inner)
        {
            if (inner == null)
        ...
        /// <returns>The original object that allows a fluent code style.</returns>
        public TSelf Display(Expression<Func<UIContext<T, TParentUIContext>, string>> textBuilderExpression)
        {
